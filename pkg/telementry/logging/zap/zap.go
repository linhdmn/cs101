...
// init set the default logger to zap Logger when this package is imported
func init() {
...
// New return a new zap Logger, it will panic calling Build() on the given config return error
...
// LocalConfig return config for running app locally, or run in test
